...
export const Stadistics = () => {
  return (
    <section
      className={`${lexend.className} md:bg-mundi bg-mundiMobile w-full  border-red-400   sm:bg-[#D9D9DD]  flex justify-center items-center bg-no-repeat bg-center bg-cover py-20 h-lvh  `}
    >
