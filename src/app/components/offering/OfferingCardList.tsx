...
export const OfferingCardList = () => {
  return (
    <>
      <div className="sm:grid grid-cols-2 2xl:grid-cols-3 gap-5 place-content-center place-items-center lg:w-10/12 xl:w-7/12 2xl:w-full 2xl:max-w-7xl m-auto hidden">
