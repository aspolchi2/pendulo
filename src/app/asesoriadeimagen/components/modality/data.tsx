const textAsesoria1 = (
  <p className="w-[65ch] 2xl:text-2xl xl:text-xl">
    ...
    maquilladores, estilistas, peluqueros, diseñadores de indumentaria,
    fotógrafos de moda, vestuaristas, etc.
  </p>
);
...
const textInterior2 = (
  <p className="w-[65ch] 2xl:text-2xl xl:text-xl">
    ...
    (arquitectos, diseñadores industriales, artistas plásticos).
  </p>
);
