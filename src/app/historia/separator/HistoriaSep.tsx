...
const HistoriaSep = () => {
  return (
    <section
      className={`sm:bg-historiaSep bg-historiaMobileDiv lg:bg-cover bg-cover lg:p-24 sm:p-12 lg:h-[60vh]  sm:justify-center lg:py-28 lg:px-28 text-white ${hepta_slab.className} flex flex-col sm:gap-8 h-[700px] bg-center justify-end pb-12 text-center sm:text-left text-balance gap-2`}
    >
